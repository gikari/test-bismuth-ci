...
## [4.0.0](https://www.github.com/gikari/test-bismuth-ci/compare/v3.0.0...v4.0.0) (2021-11-08)


### ⚠ BREAKING CHANGES

* publish install artifact instead of build one
* use CMake for building the kwinscript part
...
* publish install artifact instead of build one ([895fb4c](https://www.github.com/gikari/test-bismuth-ci/commit/895fb4c385e6e7dbcd14effebe28a5a3747aaa1e))
* use CMake for building the kwinscript part ([ac4bbe9](https://www.github.com/gikari/test-bismuth-ci/commit/ac4bbe94283870642426cf740628efb54a5dc900))
